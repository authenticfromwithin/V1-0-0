\
@echo off
REM encode-journey.bat <state> <input.mov>
setlocal
if "%~1"=="" echo Usage: %~nx0 <state> <input.mov> & exit /b 1
if "%~2"=="" echo Usage: %~nx0 <state> <input.mov> & exit /b 1
...
set "OUTDIR=public\assets\avatars\journey\%STATE%"
